...
'''
Codes copy from https://github.com/marmakoide/inside-3d-mesh
'''

def IsAPointInsideMesh(triangles, X):
    ...
    # Job done
    return winding_number >= 2.0 * numpy
...
def IsPointsInsideMesh(triangles, X):
